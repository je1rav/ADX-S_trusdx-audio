...
受信感度は，プログラムの1193行目の割り算の分母を調節してみてください．（大きくすると感度が下がります．）  
...
#### CD2003の出力信号をATmega328PのADC端子に接続するために，CD2003のDET_OUT(11番ピン)とArduino Nano互換ボードのA2ピン(21番ピン)の間にオーディオアンプを挿入します．  
	...
	ゲイン200倍で使用するため，1ピンー8ピン間に10uFのコンデンサを接続します．　（2024/3/17 コメント：このコンデンサを付けずにゲイン20倍で使用する方が良さそうです．）
...
#### 必要部品  
	オーディオIC LM386：1個
	積層セラミックコンデンサー105：1個
	積層セラミックコンデンサー106：1個　（不要かも）

## ADX-S（CRkits共同購入プロジェクト）の改造の追加 （2024/3/17）
テストした時の受信アンテナ(MLA, SLA)のチューニングがずれていて，アンテナ感度が低下していました．   
アンテナを調整して，調べた結果，オーディオアンプLM386のゲイン（200倍）が高すぎるようだと思われます．   
C2 (10uF, 106)を取り付けずに，ゲイン20倍で使用した方が良さそうです．（後ほど，本文を修正します．）   
